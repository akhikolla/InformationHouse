...
TEST(cenROC_deepstate_test,sieve_test){
  ...
  qs::c_qsave(Utmp,"/home/akhila/fuzzer_packages/fuzzedpackages/cenROC/inst/testfiles/sieve/inputs/Utmp.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "Utmp values: "<< Utmp << std::endl;
  NumericVector Vtmp  = RcppDeepState_NumericVector();
  qs::c_qsave(Vtmp,"/home/akhila/fuzzer_packages/fuzzedpackages/cenROC/inst/testfiles/sieve/inputs/Vtmp.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "Vtmp values: "<< Vtmp << std::endl;
  NumericVector Markertmp  = RcppDeepState_NumericVector();
  qs::c_qsave(Markertmp,"/home/akhila/fuzzer_packages/fuzzedpackages/cenROC/inst/testfiles/sieve/inputs/Markertmp.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "Markertmp values: "<< Markertmp << std::endl;
  NumericVector Deltatmp  = RcppDeepState_NumericVector();
  qs::c_qsave(Deltatmp,"/home/akhila/fuzzer_packages/fuzzedpackages/cenROC/inst/testfiles/sieve/inputs/Deltatmp.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "Deltatmp values: "<< Deltatmp << std::endl;
  NumericVector KnotI  = RcppDeepState_NumericVector();
  qs::c_qsave(KnotI,"/home/akhila/fuzzer_packages/fuzzedpackages/cenROC/inst/testfiles/sieve/inputs/KnotI.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "KnotI values: "<< KnotI << std::endl;
  NumericVector KnotM  = RcppDeepState_NumericVector();
  qs::c_qsave(KnotM,"/home/akhila/fuzzer_packages/fuzzedpackages/cenROC/inst/testfiles/sieve/inputs/KnotM.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "KnotM values: "<< KnotM << std::endl;
  IntegerVector ki(1);
  ki[0]  = RcppDeepState_int();
  qs::c_qsave(ki,"/home/akhila/fuzzer_packages/fuzzedpackages/cenROC/inst/testfiles/sieve/inputs/ki.qs",
		"high", "zstd", 1, 15, true, 1);
