...
TEST(Umatrix_deepstate_test,addRowWiseC_test){
  ...
  qs::c_qsave(WeightVectors,"/home/akhila/fuzzer_packages/fuzzedpackages/Umatrix/inst/testfiles/addRowWiseC/inputs/WeightVectors.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "WeightVectors values: "<< WeightVectors << std::endl;
  NumericVector DataPoint  = RcppDeepState_NumericVector();
  qs::c_qsave(DataPoint,"/home/akhila/fuzzer_packages/fuzzedpackages/Umatrix/inst/testfiles/addRowWiseC/inputs/DataPoint.qs",
		"high", "zstd", 1, 15, true, 1);
