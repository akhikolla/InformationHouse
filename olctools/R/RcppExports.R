...
encode_olc <- function(lats, longs, length) {
    .Call('_olctools_encode_olc', PACKAGE = 'olctools', lats, longs, length)
}
...
shorten_olc <- function(olcs, lats, longs) {
    .Call('_olctools_shorten_olc', PACKAGE = 'olctools', olcs, lats, longs)
}
...
recover_olc <- function(olcs, lats, longs) {
    .Call('_olctools_recover_olc', PACKAGE = 'olctools', olcs, lats, longs)
}
