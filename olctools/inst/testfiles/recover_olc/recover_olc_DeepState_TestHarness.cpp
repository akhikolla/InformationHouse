...
TEST(olctools_deepstate_test,recover_olc_test){
  ...
  qs::c_qsave(olcs,"/home/akhila/fuzzer_packages/fuzzedpackages/olctools/inst/testfiles/recover_olc/inputs/olcs.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "olcs values: "<< olcs << std::endl;
  NumericVector lats  = RcppDeepState_NumericVector();
  qs::c_qsave(lats,"/home/akhila/fuzzer_packages/fuzzedpackages/olctools/inst/testfiles/recover_olc/inputs/lats.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "lats values: "<< lats << std::endl;
  NumericVector longs  = RcppDeepState_NumericVector();
  qs::c_qsave(longs,"/home/akhila/fuzzer_packages/fuzzedpackages/olctools/inst/testfiles/recover_olc/inputs/longs.qs",
		"high", "zstd", 1, 15, true, 1);
