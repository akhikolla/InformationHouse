...
TEST(swephR_deepstate_test,heliacal_angle_test){
  ...
  qs::c_qsave(jd_ut,"/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/heliacal_angle/inputs/jd_ut.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "jd_ut values: "<< jd_ut << std::endl;
  NumericVector dgeo  = RcppDeepState_NumericVector();
  qs::c_qsave(dgeo,"/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/heliacal_angle/inputs/dgeo.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "dgeo values: "<< dgeo << std::endl;
  NumericVector datm  = RcppDeepState_NumericVector();
  qs::c_qsave(datm,"/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/heliacal_angle/inputs/datm.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "datm values: "<< datm << std::endl;
  NumericVector dobs  = RcppDeepState_NumericVector();
  qs::c_qsave(dobs,"/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/heliacal_angle/inputs/dobs.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "dobs values: "<< dobs << std::endl;
  IntegerVector helflag(1);
  helflag[0]  = RcppDeepState_int();
  qs::c_qsave(helflag,"/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/heliacal_angle/inputs/helflag.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "helflag values: "<< helflag << std::endl;
  NumericVector mag(1);
  mag[0]  = RcppDeepState_double();
  qs::c_qsave(mag,"/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/heliacal_angle/inputs/mag.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "mag values: "<< mag << std::endl;
  NumericVector AziO(1);
  AziO[0]  = RcppDeepState_double();
  qs::c_qsave(AziO,"/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/heliacal_angle/inputs/AziO.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "AziO values: "<< AziO << std::endl;
  NumericVector AziS(1);
  AziS[0]  = RcppDeepState_double();
  qs::c_qsave(AziS,"/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/heliacal_angle/inputs/AziS.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "AziS values: "<< AziS << std::endl;
  NumericVector AziM(1);
  AziM[0]  = RcppDeepState_double();
  qs::c_qsave(AziM,"/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/heliacal_angle/inputs/AziM.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "AziM values: "<< AziM << std::endl;
  NumericVector AltM(1);
  AltM[0]  = RcppDeepState_double();
  qs::c_qsave(AltM,"/home/akhila/fuzzer_packages/fuzzedpackages/swephR/inst/testfiles/heliacal_angle/inputs/AltM.qs",
		"high", "zstd", 1, 15, true, 1);
