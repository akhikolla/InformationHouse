...
TEST(FENmlm_deepstate_test,cpppar_trigamma_test){
  RInside R;
  std::cout << "input starts" << std::endl;
  NumericVector x  = RcppDeepState_NumericVector();
  qs::c_qsave(x,"/home/akhila/fuzzer_packages/fuzzedpackages/FENmlm/inst/testfiles/cpppar_trigamma/inputs/x.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "x values: "<< x << std::endl;
  IntegerVector nthreads(1);
  nthreads[0]  = RcppDeepState_int();
  qs::c_qsave(nthreads,"/home/akhila/fuzzer_packages/fuzzedpackages/FENmlm/inst/testfiles/cpppar_trigamma/inputs/nthreads.qs",
		"high", "zstd", 1, 15, true, 1);
