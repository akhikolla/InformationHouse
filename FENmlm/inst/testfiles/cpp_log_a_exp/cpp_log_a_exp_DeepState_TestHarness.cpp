...
TEST(FENmlm_deepstate_test,cpp_log_a_exp_test){
  ...
  qs::c_qsave(a,"/home/akhila/fuzzer_packages/fuzzedpackages/FENmlm/inst/testfiles/cpp_log_a_exp/inputs/a.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "a values: "<< a << std::endl;
  NumericVector mu  = RcppDeepState_NumericVector();
  qs::c_qsave(mu,"/home/akhila/fuzzer_packages/fuzzedpackages/FENmlm/inst/testfiles/cpp_log_a_exp/inputs/mu.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "mu values: "<< mu << std::endl;
  NumericVector exp_mu  = RcppDeepState_NumericVector();
  qs::c_qsave(exp_mu,"/home/akhila/fuzzer_packages/fuzzedpackages/FENmlm/inst/testfiles/cpp_log_a_exp/inputs/exp_mu.qs",
		"high", "zstd", 1, 15, true, 1);
