...
RcppExport SEXP _MultivariateRandomForest_splitt2(SEXP XSEXP, SEXP YSEXP, SEXP m_featureSEXP, SEXP IndexSEXP, SEXP Inv_Cov_YSEXP, SEXP CommandSEXP, SEXP ffSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(splitt2(X, Y, m_feature, Index, Inv_Cov_Y, Command, ff));
    return rcpp_result_gen;
END_RCPP
}
// Node_cost
double Node_cost(NumericMatrix y, NumericMatrix Inv_Cov_Y, int Command);
RcppExport SEXP _MultivariateRandomForest_Node_cost(SEXP ySEXP, SEXP Inv_Cov_YSEXP, SEXP CommandSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix >::type y(ySEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_MultivariateRandomForest_splitt2", (DL_FUNC) &_MultivariateRandomForest_splitt2, 7},
    {"_MultivariateRandomForest_Node_cost", (DL_FUNC) &_MultivariateRandomForest_Node_cost, 3},
    {NULL, NULL, 0}
};

RcppExport void R_init_MultivariateRandomForest(DllInfo *dll) {
