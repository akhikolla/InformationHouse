...
TEST(interp_deepstate_test,left_test){
  ...
  qs::c_qsave(x1,"/home/akhila/fuzzer_packages/fuzzedpackages/interp/inst/testfiles/left/inputs/x1.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "x1 values: "<< x1 << std::endl;
  NumericVector y1(1);
  y1[0]  = RcppDeepState_double();
  qs::c_qsave(y1,"/home/akhila/fuzzer_packages/fuzzedpackages/interp/inst/testfiles/left/inputs/y1.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "y1 values: "<< y1 << std::endl;
  NumericVector x2(1);
  x2[0]  = RcppDeepState_double();
  qs::c_qsave(x2,"/home/akhila/fuzzer_packages/fuzzedpackages/interp/inst/testfiles/left/inputs/x2.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "x2 values: "<< x2 << std::endl;
  NumericVector y2(1);
  y2[0]  = RcppDeepState_double();
  qs::c_qsave(y2,"/home/akhila/fuzzer_packages/fuzzedpackages/interp/inst/testfiles/left/inputs/y2.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "y2 values: "<< y2 << std::endl;
  NumericVector x0  = RcppDeepState_NumericVector();
  qs::c_qsave(x0,"/home/akhila/fuzzer_packages/fuzzedpackages/interp/inst/testfiles/left/inputs/x0.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "x0 values: "<< x0 << std::endl;
  NumericVector y0  = RcppDeepState_NumericVector();
  qs::c_qsave(y0,"/home/akhila/fuzzer_packages/fuzzedpackages/interp/inst/testfiles/left/inputs/y0.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "y0 values: "<< y0 << std::endl;
  NumericVector eps(1);
  eps[0]  = RcppDeepState_double();
  qs::c_qsave(eps,"/home/akhila/fuzzer_packages/fuzzedpackages/interp/inst/testfiles/left/inputs/eps.qs",
		"high", "zstd", 1, 15, true, 1);
