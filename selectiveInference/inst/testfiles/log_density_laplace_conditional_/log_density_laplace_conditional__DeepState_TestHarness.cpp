...
TEST(selectiveInference_deepstate_test,log_density_laplace_conditional__test){
  ...
  qs::c_qsave(noise_scale,"/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/log_density_laplace_conditional_/inputs/noise_scale.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "noise_scale values: "<< noise_scale << std::endl;
  NumericMatrix optimization_linear  = RcppDeepState_NumericMatrix();
  qs::c_qsave(optimization_linear,"/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/log_density_laplace_conditional_/inputs/optimization_linear.qs",
		"high", "zstd", 1, 15, true, 1);
  ...
  qs::c_qsave(optimization_state,"/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/log_density_laplace_conditional_/inputs/optimization_state.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "optimization_state values: "<< optimization_state << std::endl;
  NumericVector offset  = RcppDeepState_NumericVector();
  qs::c_qsave(offset,"/home/akhila/fuzzer_packages/fuzzedpackages/selectiveInference/inst/testfiles/log_density_laplace_conditional_/inputs/offset.qs",
		"high", "zstd", 1, 15, true, 1);
