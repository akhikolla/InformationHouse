...
TEST(rankdist_deepstate_test,FindCayley_test){
  ...
  qs::c_qsave(obs,"/home/akhila/fuzzer_packages/fuzzedpackages/rankdist/inst/testfiles/FindCayley/inputs/obs.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "obs values: "<< obs << std::endl;
  NumericVector pi0  = RcppDeepState_NumericVector();
  qs::c_qsave(pi0,"/home/akhila/fuzzer_packages/fuzzedpackages/rankdist/inst/testfiles/FindCayley/inputs/pi0.qs",
		"high", "zstd", 1, 15, true, 1);
