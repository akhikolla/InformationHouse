...
TEST(CKLRT_deepstate_test,doubleloop_LRT_test){
  ...
  qs::c_qsave(K1R,"/home/akhila/fuzzer_packages/fuzzedpackages/CKLRT/inst/testfiles/doubleloop_LRT/inputs/K1R.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "K1R values: "<< K1R << std::endl;
  NumericMatrix K2R  = RcppDeepState_NumericMatrix();
  qs::c_qsave(K2R,"/home/akhila/fuzzer_packages/fuzzedpackages/CKLRT/inst/testfiles/doubleloop_LRT/inputs/K2R.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "K2R values: "<< K2R << std::endl;
  NumericMatrix P0R  = RcppDeepState_NumericMatrix();
  qs::c_qsave(P0R,"/home/akhila/fuzzer_packages/fuzzedpackages/CKLRT/inst/testfiles/doubleloop_LRT/inputs/P0R.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "P0R values: "<< P0R << std::endl;
  NumericMatrix AR  = RcppDeepState_NumericMatrix();
  qs::c_qsave(AR,"/home/akhila/fuzzer_packages/fuzzedpackages/CKLRT/inst/testfiles/doubleloop_LRT/inputs/AR.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "AR values: "<< AR << std::endl;
  NumericMatrix U1R  = RcppDeepState_NumericMatrix();
  qs::c_qsave(U1R,"/home/akhila/fuzzer_packages/fuzzedpackages/CKLRT/inst/testfiles/doubleloop_LRT/inputs/U1R.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "U1R values: "<< U1R << std::endl;
  NumericMatrix wR  = RcppDeepState_NumericMatrix();
  qs::c_qsave(wR,"/home/akhila/fuzzer_packages/fuzzedpackages/CKLRT/inst/testfiles/doubleloop_LRT/inputs/wR.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "wR values: "<< wR << std::endl;
  NumericVector LamdasR  = RcppDeepState_NumericVector();
  qs::c_qsave(LamdasR,"/home/akhila/fuzzer_packages/fuzzedpackages/CKLRT/inst/testfiles/doubleloop_LRT/inputs/LamdasR.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "LamdasR values: "<< LamdasR << std::endl;
  IntegerVector nminuspx(1);
  nminuspx[0]  = RcppDeepState_int();
  qs::c_qsave(nminuspx,"/home/akhila/fuzzer_packages/fuzzedpackages/CKLRT/inst/testfiles/doubleloop_LRT/inputs/nminuspx.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "nminuspx values: "<< nminuspx << std::endl;
  NumericVector all_rho  = RcppDeepState_NumericVector();
  qs::c_qsave(all_rho,"/home/akhila/fuzzer_packages/fuzzedpackages/CKLRT/inst/testfiles/doubleloop_LRT/inputs/all_rho.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "all_rho values: "<< all_rho << std::endl;
  NumericMatrix LR0_allRhoR  = RcppDeepState_NumericMatrix();
  qs::c_qsave(LR0_allRhoR,"/home/akhila/fuzzer_packages/fuzzedpackages/CKLRT/inst/testfiles/doubleloop_LRT/inputs/LR0_allRhoR.qs",
		"high", "zstd", 1, 15, true, 1);
