...
TEST(dbscan_deepstate_test,frNN_int_test){
  ...
  qs::c_qsave(data,"/home/akhila/fuzzer_packages/fuzzedpackages/dbscan/inst/testfiles/frNN_int/inputs/data.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "data values: "<< data << std::endl;
  NumericVector eps(1);
  eps[0]  = RcppDeepState_double();
  qs::c_qsave(eps,"/home/akhila/fuzzer_packages/fuzzedpackages/dbscan/inst/testfiles/frNN_int/inputs/eps.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "eps values: "<< eps << std::endl;
  IntegerVector type(1);
  type[0]  = RcppDeepState_int();
  qs::c_qsave(type,"/home/akhila/fuzzer_packages/fuzzedpackages/dbscan/inst/testfiles/frNN_int/inputs/type.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "type values: "<< type << std::endl;
  IntegerVector bucketSize(1);
  bucketSize[0]  = RcppDeepState_int();
  qs::c_qsave(bucketSize,"/home/akhila/fuzzer_packages/fuzzedpackages/dbscan/inst/testfiles/frNN_int/inputs/bucketSize.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "bucketSize values: "<< bucketSize << std::endl;
  IntegerVector splitRule(1);
  splitRule[0]  = RcppDeepState_int();
  qs::c_qsave(splitRule,"/home/akhila/fuzzer_packages/fuzzedpackages/dbscan/inst/testfiles/frNN_int/inputs/splitRule.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "splitRule values: "<< splitRule << std::endl;
  NumericVector approx(1);
  approx[0]  = RcppDeepState_double();
  qs::c_qsave(approx,"/home/akhila/fuzzer_packages/fuzzedpackages/dbscan/inst/testfiles/frNN_int/inputs/approx.qs",
		"high", "zstd", 1, 15, true, 1);
