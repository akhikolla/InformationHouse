...
TEST(imp4p_deepstate_test,fast_apply_nb_na_test){
  ...
  qs::c_qsave(X,"/home/akhila/fuzzer_packages/fuzzedpackages/imp4p/inst/testfiles/fast_apply_nb_na/inputs/X.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "X values: "<< X << std::endl;
  IntegerVector dim(1);
  dim[0]  = RcppDeepState_int();
  qs::c_qsave(dim,"/home/akhila/fuzzer_packages/fuzzedpackages/imp4p/inst/testfiles/fast_apply_nb_na/inputs/dim.qs",
		"high", "zstd", 1, 15, true, 1);
