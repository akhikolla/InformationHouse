...
TEST(libstableR_deepstate_test,stable_fit_mle2d_test){
  ...
  qs::c_qsave(rnd,"/home/akhila/fuzzer_packages/fuzzedpackages/libstableR/inst/testfiles/stable_fit_mle2d/inputs/rnd.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "rnd values: "<< rnd << std::endl;
  NumericVector pars_init  = RcppDeepState_NumericVector();
  qs::c_qsave(pars_init,"/home/akhila/fuzzer_packages/fuzzedpackages/libstableR/inst/testfiles/stable_fit_mle2d/inputs/pars_init.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "pars_init values: "<< pars_init << std::endl;
  IntegerVector parametrization(1);
  parametrization[0]  = RcppDeepState_int();
  qs::c_qsave(parametrization,"/home/akhila/fuzzer_packages/fuzzedpackages/libstableR/inst/testfiles/stable_fit_mle2d/inputs/parametrization.qs",
		"high", "zstd", 1, 15, true, 1);
