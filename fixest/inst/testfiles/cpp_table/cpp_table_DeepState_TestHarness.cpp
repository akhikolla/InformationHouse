...
TEST(fixest_deepstate_test,cpp_table_test){
  RInside R;
  std::cout << "input starts" << std::endl;
  IntegerVector Q(1);
  Q[0]  = RcppDeepState_int();
  qs::c_qsave(Q,"/home/akhila/fuzzer_packages/fuzzedpackages/fixest/inst/testfiles/cpp_table/inputs/Q.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "Q values: "<< Q << std::endl;
  IntegerVector dum  = RcppDeepState_IntegerVector();
  qs::c_qsave(dum,"/home/akhila/fuzzer_packages/fuzzedpackages/fixest/inst/testfiles/cpp_table/inputs/dum.qs",
		"high", "zstd", 1, 15, true, 1);
