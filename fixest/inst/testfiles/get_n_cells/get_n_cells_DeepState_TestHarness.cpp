...
TEST(fixest_deepstate_test,get_n_cells_test){
  ...
  qs::c_qsave(index_i,"/home/akhila/fuzzer_packages/fuzzedpackages/fixest/inst/testfiles/get_n_cells/inputs/index_i.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "index_i values: "<< index_i << std::endl;
  IntegerVector index_j  = RcppDeepState_IntegerVector();
  qs::c_qsave(index_j,"/home/akhila/fuzzer_packages/fuzzedpackages/fixest/inst/testfiles/get_n_cells/inputs/index_j.qs",
		"high", "zstd", 1, 15, true, 1);
