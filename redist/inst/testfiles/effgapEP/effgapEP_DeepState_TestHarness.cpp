...
TEST(redist_deepstate_test,effgapEP_test){
  ...
  qs::c_qsave(dvs,"/home/akhila/fuzzer_packages/fuzzedpackages/redist/inst/testfiles/effgapEP/inputs/dvs.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "dvs values: "<< dvs << std::endl;
  IntegerVector dseat_vec  = RcppDeepState_IntegerVector();
  qs::c_qsave(dseat_vec,"/home/akhila/fuzzer_packages/fuzzedpackages/redist/inst/testfiles/effgapEP/inputs/dseat_vec.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "dseat_vec values: "<< dseat_vec << std::endl;
  IntegerVector nd(1);
  nd[0]  = RcppDeepState_int();
  qs::c_qsave(nd,"/home/akhila/fuzzer_packages/fuzzedpackages/redist/inst/testfiles/effgapEP/inputs/nd.qs",
		"high", "zstd", 1, 15, true, 1);
