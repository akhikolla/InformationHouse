...
TEST(FKSUM_deepstate_test,cbin_alloc_test){
  ...
  qs::c_qsave(x,"/home/akhila/fuzzer_packages/fuzzedpackages/FKSUM/inst/testfiles/cbin_alloc/inputs/x.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "x values: "<< x << std::endl;
  IntegerVector nbin(1);
  nbin[0]  = RcppDeepState_int();
  qs::c_qsave(nbin,"/home/akhila/fuzzer_packages/fuzzedpackages/FKSUM/inst/testfiles/cbin_alloc/inputs/nbin.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "nbin values: "<< nbin << std::endl;
  NumericVector min(1);
  min[0]  = RcppDeepState_double();
  qs::c_qsave(min,"/home/akhila/fuzzer_packages/fuzzedpackages/FKSUM/inst/testfiles/cbin_alloc/inputs/min.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "min values: "<< min << std::endl;
  NumericVector max(1);
  max[0]  = RcppDeepState_double();
  qs::c_qsave(max,"/home/akhila/fuzzer_packages/fuzzedpackages/FKSUM/inst/testfiles/cbin_alloc/inputs/max.qs",
		"high", "zstd", 1, 15, true, 1);
