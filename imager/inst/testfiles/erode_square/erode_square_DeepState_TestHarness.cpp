...
TEST(imager_deepstate_test,erode_square_test){
  ...
  qs::c_qsave(im,"/home/akhila/fuzzer_packages/fuzzedpackages/imager/inst/testfiles/erode_square/inputs/im.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "im values: "<< im << std::endl;
  IntegerVector size(1);
  size[0]  = RcppDeepState_int();
  qs::c_qsave(size,"/home/akhila/fuzzer_packages/fuzzedpackages/imager/inst/testfiles/erode_square/inputs/size.qs",
		"high", "zstd", 1, 15, true, 1);
